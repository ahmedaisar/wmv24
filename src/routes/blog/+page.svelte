                    ...
                    <div class="mb-5 pb-1">                        
                        ...
                        <div class="mb-4">
                            ...
                            <h5 class="font-weight-bold font-size-21 text-gray-3">
                                <a href="blog-single.html">{blog.title.rendered}</a>
                            </h5>
                            <div class="mb-3">
                            ...
                            <p class="mb-0 text-lh-lg">Simple point-and-shoot digital cameras can give surprising quality when they have the right lenses and sensors. Because they are totally automatic in focus and exposure, they just have to be pointed at a subject and clicked. They have limited capabilities for controlling the image, although …
                            </p>
                        </div>
                        {/each}                      
                    </div>
