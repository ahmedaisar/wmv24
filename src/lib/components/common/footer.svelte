                ...
                <div class="col-12 col-lg-6 mb-6 mb-md-10 mb-xl-0">
                    ...
                    <div class ="d-md-flex d-lg-block">
                        <div class="mb-5 mr-md-7 mr-lg-0">
                            <h4 class="h6 mb-4 font-weight-bold">MaldivesBeachVacation.com</h4>
                            <a href="/">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <div class="mb-2 h6 font-weight-normal text-gray-1">Your Exclusive Portal to the Maldives. Explore and discern among the finest luxury hotels and resorts with our tailored search and comparison features, ensuring a sophisticated and unmatched stay in this tropical haven</div>
                            ...
                            <!-- <div class="mb-4">
                                ...
                                <address class="pr-4">
                                    <span class="mb-2 h6 font-weight-normal text-gray-1">
                                        +960 960 7915687 | FW Residences HM-03-06, Hulhumale, Maldives
                                    </span>
                                </address>
                            </div> -->
